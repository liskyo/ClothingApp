    ...
    <section class="glass-panel p-8 rounded-2xl relative overflow-hidden">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-end">
        ...
        <div class="group">
           ...
           <label class="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-slate-600 rounded-lg cursor-pointer hover:border-purple-500 hover:bg-slate-800/50 transition-all">
             <span class="text-sm text-slate-300 truncate">{{ userFile ? userFile.name : 'Choose File...' }}</span>
